...
namespace App\Models {
     ...
     * App\Models\Permiso
     *
     * @property smallint $permisocondicion
     * @property character varying(100) $permisonombre
     * @property int $idpermiso
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Rol> $roles
     * @property-read int|null $roles_count
     * @method static \Illuminate\Database\Eloquent\Builder|Permiso whereIdpermiso($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Permiso wherePermisonombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Permiso wherePermisocondicion($value)
     ...
     * App\Models\Rol
     *
     * @property smallint $rolcondicion
     * @property character varying(100) $rolnombre
     * @property int $idrol
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|Rol whereRolnombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder|Rol whereRolcondicion($value)
